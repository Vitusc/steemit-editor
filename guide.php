...
<h1><a href="http://vituscprojects.xaa.pl/"><button type="button" class="btn btn-default">Back to Home</button></a></h1>
<h4>Emphasis</h4>
...
alert(example);
```</pre>
<footer>Author: <a href="https://steemit.com/@vitusc" target="_blank">@vitusc</a></footer>
</div>
</div>
</div>
<script>
